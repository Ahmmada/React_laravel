      ...
      <div className="min-h-screen bg-background">
        <div className="container mx-auto px-3 py-4 max-w-7xl">
          ...
          <div className="flex items-center gap-3 mb-6">
            <div>
              <h2 className="text-lg font-semibold text-foreground">إعداد التقرير</h2>
              <p className="text-sm text-muted-foreground">قم بتهيئة التقرير وتصفية البيانات حسب الاحتياجات</p>
            </div>
          </div>

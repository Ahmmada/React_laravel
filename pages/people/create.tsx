...
export default function Create() {
    const { cardTypes, centers, housingTypes } = usePage<PageProps>().props;
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <Input
                                        ...
                                        required
                                    />
                                    {errors.social_status && <p className="text-red-500 text-sm mt-1">{errors.social_status}</p>}
                                </div>
                                <div>
...
onValueChange={(value) => setData("housing_type_id", value === "" ? null : Number(value))}                          
                  ...
                  {housingTypes.map((type) => (
                                ...
                                <div>
                                    <Label htmlFor="center_id">المركز</Label>
                                    <Select
                                        value={data.center_id ? String(data.center_id) : ""}
                                        onValueChange={(value) => setData("center_id", value === "" ? null : Number(value))}
                                    >
                   ...
                   {centers.map((center) => (
                            ...
                            <div className="space-y-4 pt-6 border-t mt-6">
                                ...
                                {data.family_members.map((member, index) => (
                                    <Card key={member.id} className="p-4 relative">
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                            <div>
                                                <Label htmlFor={`member-birth_date-${index}`}>تاريخ ميلاد فرد الأسرة</Label>
                                                <Input
                                                    id={`member-birth_date-${index}`}
                                                    type="date"
                                                    value={member.birth_date}
                                                    onChange={(e) =>
                                                        handleFamilyMemberChange(index, "birth_date", e.target.value)
                                                    }
                                                    required
                                                />
                            ...
                            <div className="flex justify-end gap-2 mt-8">
                                ...
                                <Button type="button" variant="outline" onClick={() => router.visit(route('people.index'))}>
                                    إلغاء
                                </Button>
                            </div>
                        </form>
